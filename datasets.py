...
class HUNCCInputDataset(torch.utils.data.Dataset):
    def __init__(self, N, tensorHunccData, tensorInputData, x_dim, z_dim):
        self.x = tensorHunccData
        self.y = tensorInputData
    ...
    def __len__(self):
        return self.N
    # I just returned the lenth of our vectors
